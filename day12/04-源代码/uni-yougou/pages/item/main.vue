<template>
  <div class="wrapper">
    ...
    <div class="goods-detail">
      <div class="tabs">
        <span :class="{active:activeIndex===0}" @click="activeIndex=0">图文介绍</span>
        <span :class="{active:activeIndex===1}" @click="activeIndex=1">规格参数</span>
      </div>
      <div class="main">
    ...
    <div class="fixed-bottom">
      ...
      <div class="btn buy-btn" @click="toPay">立即购买</div>
    </div>
  </div>
</template>
<script>
