...
var _main = _interopRequireDefault(__webpack_require__(/*! ./pages/me/main.vue */ 47));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _main_vue_vue_type_template_id_2ff09a62___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.vue?vue&type=template&id=2ff09a62& */ 48);
...
/* harmony import */ var _main_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./main.vue?vue&type=style&index=0&lang=less& */ 52);
...
var DEFAULT_IMG_URL = 'http://www.sucaijishi.com/uploadfile/2018/0508/20180508023717621.png';var _default =
{
  data: function data() {
    return {
      ...
      {
        title: '待付款',
        fontCls: 'icon-pre-pay',
        index: 1 },

      {
        title: '待收货',
        fontCls: 'icon-pre-send',
        index: 2 },

      {
        title: '退款/退货',
        fontCls: 'icon-goods-reject',
        index: 3 },

      {
        title: '全部订单',
        fontCls: 'icon-all-order',
        index: 0 }] };
  ...
  methods: {
    ...
    makeCall: function makeCall() {
      wx.makePhoneCall({ phoneNumber: '17605089381' });
    },
