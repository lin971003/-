...
1. 前端开发
   ...
   2. 移动端
      ...
      2. 移动端浏览器H5
      3. 微信小程序
2. 总课程15天。2天基础知识 + 后面7天用mpvue完成两个项目, 最后一天uni-app
   1. 2天微信小程序基础知识
   2. 蘑菇在线项目（原生小程序语法）
   3. uniapp优购商城项目
      1. 学习uniapp
...
微信小程序课程地址：  https://gitee.com/jovenwang/learnmp  分支：mp45
...
4. 添加SSH key
   1. github头像->settings-> SSH and GPG keys-> new SSH key
      2. 添加SSH key
   5. 执行git clone, 并切换分支git checkout
...
3. 一般公司会把gitlab网站的代码部署到公司的服务器上，那么托管代码就是私有的。
   ...
   2. 员工自行添加ssh key
4. 建议学习阶段多用git命令，工作中用图形化工具sourcetree，乌龟git居多
