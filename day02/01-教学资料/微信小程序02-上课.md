...
1. 老师可以讲下电商后台系统吗
2. 不是是说<text></text>标签margin不可以用吗，我试了margin上下左右都可以用呀，包括padding上下也魔德闻提的呢。
   1. 行内元素，margin-top，margin-bottom无效，但是左右有效。padding都有效。
3. 还是把分辨率弄低点吧，我1366扛不住。。。。。。。。。今天差点瞎了
4. navigator标签页面跳转传参时可以传一个对象吗
5. require不能使用绝对路径
   1. [传送门](https://developers.weixin.qq.com/community/develop/doc/000c24ce03887054d776b752256400)
