...
const appEntry = { app: resolve('./src/main.js') } //app的入口
const pagesEntry = getEntry(resolve('./src'), 'pages/**/main.js')
const entry = Object.assign({}, appEntry, pagesEntry) //包括app的入口和所有页面的入口
...
let baseWebpackConfig = {
  ...
  resolve: {
    //引入文件名如果为js,vue,json，可以省略
    extensions: ['.js', '.vue', '.json'],
    alias: {
      //别名
      vue: 'mpvue', //在main.js引入vue，其实就是mpvue
      '@': resolve('src')
    },
    symlinks: false,
  ...
  module: {
    rules: [
      //在src目录下的所有.js或者.vue文件都会绿过eslint-loader的检查
      {
        test: /\.(js|vue)$/,
