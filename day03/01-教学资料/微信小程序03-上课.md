...
1. mpvue创建项目
   ...
   1. vue init mpvue/mpvue-quickstart mpvue-douban42
...
7. dev-server.js加入清空dist/wx目录的逻辑
  ...
  8. npm安装第三方包
         1. 安装错误 
              1. 删除掉node_modules
              2. git bash以管理员身份运行, 去到项目目录下， npm install
...
2. 创建分支 git checkout -b Fea_joven_20200108
...
3. cat id_rsa.pub，复制所有
4. 远端查看分支
5. git正常操作流程,git add,git commit, git push
...
地址： https://gitee.com/jovenwang/mpvue-douban42 

分支：Fea_joven_20200108
